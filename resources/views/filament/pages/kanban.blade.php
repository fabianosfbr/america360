<x-filament-panels::page>
    ...
    <div class="mx-auto w-full" wire:ignore>
        <details class="w-full bg-white duration-300 open:bg-gray-200">
            <summary class="relative w-full cursor-pointer bg-inherit px-5 py-3 text-base text-gray-500">
                {{ __('Filters') }}
            </summary>
    ...
    <div class="h-screen p-2">
        <div class="grid lg:grid-cols-3 md:grid-cols-4 sm:grid-cols-2 gap-3">
          <!-- To-do -->
          <div class=" rounded px-2 py-2 w-[360px]">
    ...
    <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div>
            <a href="#" class="inline-flex items-center text-xs font-normal text-gray-500 hover:underline dark:text-gray-400">
              ...
              <div class="bg-white p-2 rounded shadow-sm border-gray-100 border-2">
          ...
          <!-- WIP Kanban -->
          <div class="bg-gray-100 rounded px-2 py-2  w-[360px]">
            <!-- board category header -->
            <div class="flex flex-row justify-between items-center mb-2 mx-1">
              <div class="flex items-center">
